...
///
pub async fn get_average_cpu(instance_id: &str, duration_seconds: i32) -> Result<f64> {
    let res = get_instance_average_cpu_usage(instance_id, duration_seconds)
        .await
