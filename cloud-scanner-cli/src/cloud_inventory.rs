...
///
/// Implementing this trait when creating a new CloudInventory (for example to support another cloud provider) to ensure that cloud-scanner will be able to use it.
#[async_trait]
