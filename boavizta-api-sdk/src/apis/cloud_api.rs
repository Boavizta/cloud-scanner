...
pub async fn instance_cloud_impact_v1_cloud_aws_post(configuration: &configuration::Configuration, instance_type: Option<&str>, verbose: Option<bool>, usage_cloud: Option<crate::models::UsageCloud>) -> Result<serde_json::Value, Error<InstanceCloudImpactV1CloudAwsPostError>> {
